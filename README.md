...
> **From the same team: [ESON](https://github.com/thelabcorner/eson) —
> strict JSON for ExtendScript, [ESB64](https://github.com/thelabcorner/es-b64)
> — base64/UTF-8, [ESARR](https://github.com/thelabcorner/es-arr) — ES5 array
> methods, [ESSTR](https://github.com/thelabcorner/esstr) — string trim,
